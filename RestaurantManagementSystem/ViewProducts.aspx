<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewProducts.aspx.cs" Inherits="RestaurantManagementSystem.ViewProducts" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="background-color:#E9EBEE">
            <asp:Repeater ID="products_Repeater" runat="server" OnItemCommand="products_Repeater_ItemCommand">
                <HeaderTemplate>
                    <table>
                        <caption style="font-weight:900; font-size:large">Product Details</caption>
                        <tr>
                            <td style="width: 200px; font-size: large; font-weight:900">Product_ID</td>
                            <td style="width: 200px; font-size: large; font-weight:900">Name</td>
                            <td style="width: 200px; font-size: large; font-weight:900">Description</td>
                            <td style="width: 200px; font-size: large; font-weight:900">Quantity</td>
                             <td style="width: 200px; font-size: large; font-weight:900">Unit Price</td>
                        </tr>
                </HeaderTemplate>
                <ItemTemplate>
                    <tr>
