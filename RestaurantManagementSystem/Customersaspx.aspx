<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customersaspx.aspx.cs" Inherits="RestaurantManagementSystem.Customersaspx" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="background-color:#E9EBEE">
            <asp:Repeater ID="customers_Repeater" runat="server" OnItemCommand="customers_Repeater_ItemCommand">
                <HeaderTemplate>
                    <table>
                        <caption style="font-weight:900; font-size:large">Customer Details</caption>
                        <tr>
                            <td style="width:200px; font-size:large; font-weight:900;">ID</td>
                            <td style="width:200px; font-size:large; font-weight:900;">Name</td>
                            <td style="width:200px; font-size:large; font-weight:900;">Email</td>
                            ...
                            <td style="width:200px; font-size:large; font-weight:900;">Country</td>    
                        </tr>
                </HeaderTemplate>
                <ItemTemplate>
                    <tr>
